    ...
    internal class LoggingHelper : ILoggingHelper
    {
        ...
        public void Info(Exception ex, string message = null)
        {
            if (CurrentCategory.IsNullOrEmpty())
                ...
                Info(CurrentCategory, ex, message);
        }
        ...
        public void Debug(string format, params object[] args)
        {
            if (CurrentCategory.IsNullOrEmpty())
                ...
                Debug(CurrentCategory, string.Format(format, args));
        }
        ...
        public void Verbose(string format, params object[] args)
        {
            if (CurrentCategory.IsNullOrEmpty())
                ...
                Verbose(CurrentCategory, string.Format(format, args));
        }
        ...
        public void Verbose(string message)
        {
            if (CurrentCategory.IsNullOrEmpty())
                ...
                Verbose(CurrentCategory, message);
        }
        ...
        public void Error(Exception ex, string message = null)
        {
            if (CurrentCategory.IsNullOrEmpty())
                ...
                Error(CurrentCategory, ex, message);
        }
