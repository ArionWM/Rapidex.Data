...
//        {
//            if (CheckLogger())
//                Log.Logger.Info(category, ex, message);
//        }
...
//        {
//            if (CheckLogger())
//                Common.DefaultLogger?.LogDebug(category, string.Format(format, args));
//        }

//        public static void Debug(string format, params object[] args)
//        {
//            if (CheckLogger())
//                Common.DefaultLogger?.LogDebug(string.Format(format, args));
//        }
...
//        {
//            if (CheckLogger())
//                Log.Logger.Warn(category, ex, message);
//        }
...
//        {
//            Rapidex.Common.DefaultLogger?.LogError(ex, message);
//        }
//    }
//}
