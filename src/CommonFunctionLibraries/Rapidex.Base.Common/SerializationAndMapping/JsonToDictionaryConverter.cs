...
public class JsonToDictionaryConverter : JsonConverter<object>
{
    FloatFormat FloatFormat { get; init; } = FloatFormat.Decimal;
    UnknownNumberFormat UnknownNumberFormat { get; init; } = UnknownNumberFormat.Error;
    ObjectFormat ObjectFormat { get; init; } = ObjectFormat.Dictionary;

    public JsonToDictionaryConverter() : this(FloatFormat.Double, UnknownNumberFormat.Error, ObjectFormat.Expando) { }
    public JsonToDictionaryConverter(FloatFormat floatFormat, UnknownNumberFormat unknownNumberFormat, ObjectFormat objectFormat)
    {
    ...
    protected virtual IDictionary<string, object> CreateDictionary() =>
        ObjectFormat == ObjectFormat.Expando ? new ExpandoObject() : new DictionaryA<object>();
}
