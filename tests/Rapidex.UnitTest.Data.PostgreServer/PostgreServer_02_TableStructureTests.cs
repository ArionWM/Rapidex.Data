...
namespace Rapidex.UnitTest.Data.PostgreServer
{
    ...
    {
        public PostgreServer_02_TableStructureTests(EachTestClassIsolatedFixtureFactory<DbWithProviderFixture<PostgreSqlServerProvider>> factory) : base(factory)
        {
        }
        ...
        protected override string[] GetTableNamesInSchema(IDbSchemaScope schemaScope)
        {
            ...
            DataTable table = connection.Execute(sql).Result;
