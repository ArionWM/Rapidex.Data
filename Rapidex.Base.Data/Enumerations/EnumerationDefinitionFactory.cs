...
namespace Rapidex.Data.Enumerations
{
    internal class EnumerationDefinitionFactory
    {
        ...
        public EnumerationDefinitionFactory()
        {
          //  this.EntityMetadataFactory = new DbEntityMetadataFactoryBase();
        }
        ...
        {
            IDbEntityMetadata em = Database.Metadata.EntityMetadataFactory.Create(enumerationName, module, prefix ?? DatabaseConstants.PREFIX_ENUMERATION);
            ...
            em.Fields.AddfNotExist<string>("Name", "Name");
            em.Fields.AddfNotExist<string>("Description", "Description");
            em.Fields.AddfNotExist<Color>("Color", "Color");
            em.Fields.AddfNotExist<bool>("IsArchived", "IsArchived"); // aslında ArchiveEntity ile ekleniyor
            em.Fields.AddfNotExist<bool>("Sealed", "Sealed");
            em.Fields.AddfNotExist<string>("Icon", "Icon");
        ...
        {
            IDbEntityMetadata em = Database.Metadata.Get(enumType.Name);
            if (em == null || em.IsPremature)
            {
                em = this.CreateMetadata(enumType, module, prefix);
                Database.Metadata.AddIfNotExist(em);
            }
            else
            {
                return em;
        ...
        public IDbEntityMetadata Apply(JsonNode json, string module = null)
        {
            ...
            IDbEntityMetadata em = Database.Metadata.Get(name);
            if (em == null || em.IsPremature)
            {
