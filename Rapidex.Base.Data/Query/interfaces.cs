...
namespace Rapidex.Data
{
    ...
    {
        public SqlKata.Query Query { get; internal set; }
        string TableName { get; }
        string Alias { get; internal set; }

        IDbSchemaScope Schema { get; internal set; }

        IDbEntityMetadata EntityMetadata { get; internal set; }
    ...
    {
        IPaging Paging { get; internal set; }
    ...
    {
        OrderCollection Order { get; internal set; }
    ...
    public interface IQueryUpdater : IQueryCriteria
    {
        ...
        void Update(ObjDictionary data);
        void Delete();
    }
